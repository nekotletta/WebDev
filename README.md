# Collection of assignments done for web development class
...
- Navigation bar
- Main page with overview, and some info
- Experience page
- CRUD daily checklist page
- Contact-me page 
...
- User's profile (pulls all endpoints into one and display it)
...
- Enforce being logged in to update or delete any information in the profile


## Navigation in projects

Each project has its own very detailed readme if more information is desired.